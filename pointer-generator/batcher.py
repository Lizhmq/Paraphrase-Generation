...
class Batcher(object):
  ...
  def text_generator(self, example_generator):
    ...
    while True:
      ...
      try:
        article_text = e.features.feature['src'].bytes_list.value[0].decode() # the article text was saved under the key 'src' in the data files
        abstract_text = e.features.feature['tgt'].bytes_list.value[0].decode() # the abstract text was saved under the key 'tgt' in the data files
      except ValueError:
